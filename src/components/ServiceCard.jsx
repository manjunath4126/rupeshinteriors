...
export const ServiceIcons = {
  'Modular Kitchen': (
    <svg width="32" height="32" viewBox="0 0 48 48" fill="none" stroke="#1A1918" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
        ...
        <h3 style={{ fontSize: '1.3rem', marginBottom: '10px', color: '#1A1918' }}>{title}</h3>
        <p style={{ color: '#666562', fontSize: '0.93rem', marginBottom: '20px', flexGrow: 1, lineHeight: 1.6 }}>
          {description}
        </p>
